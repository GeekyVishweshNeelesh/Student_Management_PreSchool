...
def initialize_student_excel():
    if not os.path.exists(STUDENT_FILE):
        df = pd.DataFrame(columns=[
            'Student_ID', 'Name', 'Address', 'Age', 'Blood_Group', 
            'Father_Phone', 'Mother_Phone', 'Aadhar_Details', 'Standard'
        ])
        ...
        if os.path.exists(logo_path):
            ...
            st.markdown("""
                <div class="logo-placeholder">
                    <div>
                        <p style="margin:0;">🏫</p>
                        <p style="margin:5px 0 0 0; font-size:12px;">School Logo</p>
                        <p style="margin:5px 0 0 0; font-size:10px;">Place 'school_logo.png' here</p>
                    </div>
                </div>
            """, unsafe_allow_html=True)
    ...
    if os.path.exists(logo_path):
        ...
        placeholder_html = """
            <div class="dashboard-logo">
                <div class="logo-placeholder-dash">
                    <div>
                        <p style="margin:0;">🏫</p>
                        <p style="margin:2px 0 0 0;">Logo</p>
                    </div>
                </div>
            </div>
        """
                ...
                with st.form("update_student_form"):
                    ...
                    with col1:
                        father_phone = st.text_input("Father's Phone Number *", 
                            value=student_data.get('Father_Phone', ''))
                    
                    with col2:
                        mother_phone = st.text_input("Mother's Phone Number *", 
                            value=student_data.get('Mother_Phone', ''))
