...
# Initialize session state for login - FIXED FOR STREAMLIT CLOUD
...
def check_url_params():
    """Check URL parameters for logout or reset"""
    try:
...
def main():
    ...
    # School Logo in Dashboard (Top Right)
